...
$sql ="SELECT password FROM student WHERE username=:username and password=:password"; // Correct
...
if($query -> rowCount() > 0)
{
    $con="update student set Password=:newpassword where UserName=:username";// Correct
    //$con="update student set Password=:newpassword where password=:password";// similar passwords will be changed
